...
def main():
    ...
    if (not args.no_adapter) and (model.adapter is not None):
        ...
        if ckpt_to_load is not None and os.path.isfile(ckpt_to_load):
            ckpt = torch.load(ckpt_to_load, map_location="cpu") #/data0/fangjuntao2025/tabicl-main/checkpoints/mantis_adapter_pretrainNew/adapter_CALDA_AdapterV2_20260105_104003_best.pt
