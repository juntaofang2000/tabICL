...
class UCREvaluator:
    ...
    def evaluate_dataset(self, dataset_name: str) -> float:
        ...
        try:
            ...
            # 初始化并训练分类器
            clf = TabICLClassifier(verbose=False, checkpoint_version="tabicl-classifier-v1.1-0506.ckpt",model_path="/data0/fangjuntao2025/tabicl-main/tabICLOrignCheckpoint/tabicl-classifier-v1.1-0506.ckpt")
