...
# ----------------------------------
# Generate prior datasets on the UCR (made by fang juntao)
# ----------------------------------

torchrun --standalone --nproc_per_node=4 -m tabicl.train.run \
            --device cuda \
            --dtype float32 \
            --np_seed 42 \
            --torch_seed 42 \
            ...
            --real_data_dir "/data0/fangjuntao2025/CauKer/CauKerOrign/CauKer-main/data/" \
            --prior_type real \
            --prior_device cpu \
            --batch_size_per_gp 4 \
            --min_features 2 \
            ...
            --ff_factor 2 \
            --norm_first True \
            --checkpoint_dir /data0/fangjuntao2025/tabicl-main/src/tabicl/checkpoint/dir \
            --save_temp_every 50 \
